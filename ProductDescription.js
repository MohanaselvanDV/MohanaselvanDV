    ...
    return (
      ...
      <div className="card product" key={product.id}>
        ...
        <div className="contentBox">
          ...
          <button className="services__button" onClick={()=>toggleTab(product.id)}>View More</button>
