...
import image1 from '../assets/gy.png';
              ...
              <div className="d-flex flex-row mb-4 pb-2">
                <div className="flex-fill">
                  ...
                  <MDBTypography tag="h4" className="mb-3">
                    <p className="small text-muted">Advance:
                      <span> {r.product.deposit_amount}</span></p>

                    <p className="small text-muted">Rent:
                      <span> {r.product.rent_amount}</span>
                    </p>
                    <p className="small text-muted">Total:
                      <span>{r.product.deposit_amount + r.product.rent_amount}</span></p>
                ...
                <div>
                  <MDBCardImage
                    ...
                    src={process.env.PUBLIC_URL + "/" + r.product.product_img}
